({
    ...
    savedFilter : function(component, event, helper){
        ...
        .catch(result => {
	        var messageBox = component.find('messageBox'); 
    	    messageBox.displayToastMessage('An error occured filter is not saved. ' + result,'ERROR');        
            component.set("v.Spinner", false);
        });
    },        
    ...
    scheduleSubmit : function(component, event, helper){
        ...
        .then(function(result){
            ...
            if (!result || !component.find("active").get("v.value")){
	            ...
	            var messageBox = component.find('messageBox'); 
    	        messageBox.displayToastMessage('Schedule has validation errors and cannot be saved','ERROR');        
