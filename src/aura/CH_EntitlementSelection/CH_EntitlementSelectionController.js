({
    ...
    checkEntitlementCaseCreationSWMaintenance: function(component, event, helper){
       	if( component.get('v.entitlementSWMaintenance') == true ) {
       		helper.showToast('Warning','Warning Message','This Contract currently has Portal Case creation turned off.');
       	} 
    },
