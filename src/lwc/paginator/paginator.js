...
export default class Paginator extends LightningElement {
    ...
    @api preSelectedRows; //Pre selected records available in the data table; valid type is Array 
    ...
    setRecordsToDisplay(){
        ...
        this.dispatchEvent(new CustomEvent('paginatorchange', {detail: this.recordsToDisplay,selRecs : this.preSelectedRows})); //Send records to display on table to the parent component
    }
