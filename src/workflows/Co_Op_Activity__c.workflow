...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <recipients>
            <recipient>yvonne.locke@singlecrm.nokia.com</recipient>
            <type>user</type>
        </recipients>
        <recipients>
    ...
    <alerts>
        ...
        <ccEmails>p.e.agrawal@accenture.com; gss.partnersupport@nokia.com</ccEmails>
    ...
    <alerts>
        ...
        <ccEmails>gss.partnersupport@nokia.com; yvonne.locke@nokia.com</ccEmails>
    ...
    <fieldUpdates>
        ...
        <formula>IF((
INCLUDES(Exception__c, &apos;Activity Start Date occurred in the past&apos;)), Activity_Approved_date__c + 60,  End_Date__c + 60)</formula>
