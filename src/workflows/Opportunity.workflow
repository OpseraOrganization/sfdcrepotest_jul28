...
IF(Unweighted_Amount_EUR__c&gt;=5000000 &amp;&amp; Unweighted_Amount_EUR__c &lt;= 30000000, &apos;C2&apos;,IF(Unweighted_Amount_EUR__c &gt; 30000000, &apos;C3&apos;, &apos;&apos;)
    ...
    <fieldUpdates>
        ...
        <field>G3_Approval_Date__c</field>
        <formula>IF( ISPICKVAL(StageName ,&apos;Identify Opportunity&apos;),NULL, IF( ISPICKVAL(StageName ,&apos;Develop Opportunity&apos;),NULL,
IF( AND( ApprovalStatusTechField__c=&apos;Approved G2,Approved G3&apos;,ISBLANK(G3_Approval_Date__c)),NOW(), G3_Approval_Date__c 
    ...
    <fieldUpdates>
        ...
        <formula>IF( ISPICKVAL(StageName ,&apos;Identify Opportunity&apos;),NULL, IF( ISPICKVAL(StageName ,&apos;Develop Opportunity&apos;),NULL,
IF(ISPICKVAL(StageName ,&apos;Create Offer (Bid)&apos;),NULL,
IF( AND(ApprovalStatusTechField__c=&apos;Approved G2,Approved G3,Approved G4&apos;,ISBLANK(G4_Approval_Date__c )),NOW(), G4_Approval_Date__c 
)
)
))</formula>
...
IF( AND(ApprovalStatusTechField__c=&apos;Approved G2,Approved G3,Approved G4,Approved G5&apos;,ISBLANK(G5_Approval_Date__c) ),NOW(), G5_Approval_Date__c 
        ...
        <name>NF_G5 Approval Date Update</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
...
IF( AND(ISPICKVAL(StageName ,&apos;Win the Case (Negotiate)&apos;),ISPICKVAL(Phase_Status__c,&apos;Pending Win/Loss Declaration&apos;),ISBLANK(G5_Contract_Approval_Date__c)),Now(),
IF( AND(ISPICKVAL( StageName ,&apos;Handover (Prepare for Delivery)&apos;),  LOA_Level__c  = &apos;E&apos;,ISBLANK(G5_Contract_Approval_Date__c)) , NOW(),
 IF( AND(ISPICKVAL( StageName ,&apos;Handover (Prepare for Delivery)&apos;), NF_LoA_Bypass__c&gt;0, No_Offer_Support__c&lt;2,ISBLANK(G5_Contract_Approval_Date__c)) , NOW() ,   
IF(AND(ISPICKVAL(StageName ,&apos;Handover (Prepare for Delivery)&apos;),No_Offer_Support__c&gt;1,ISBLANK(G5_Contract_Approval_Date__c)),Now(),G5_Contract_Approval_Date__c 
)
)
)
) 
...
OIF_Value_Won_USD__c, 
 OIF_Value_Cancel_USD__c)</formula>
    ...
    <rules>
        ...
        <actions>
            <name>G3_Submission_dates_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>G4_Submission_dates_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>G5_Submission_dates_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND( $User.ProfileId != $Label.Data_Loader_Profile_Id, ISPICKVAL(PRIORVALUE(StageName) , &apos;Develop Opportunity&apos;), OR(No_Offer_Support__c =1,No_Offer_Support__c =3), ISPICKVAL(StageName , &apos;Create Offer (Bid)&apos;) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND($User.ProfileId != $Label.Data_Loader_Profile_Id, ISPICKVAL(PRIORVALUE(StageName) , &apos;Win the Case (Negotiate)&apos;),  OR(NF_LoA_Bypass__c=2,NF_LoA_Bypass__c=3), ISPICKVAL(StageName , &apos;Handover (Prepare for Delivery)&apos;) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <formula>AND( $User.ProfileId != $Label.Data_Loader_Profile_Id, ISPICKVAL(PRIORVALUE(StageName) , &apos;Handover (Prepare for Delivery)&apos;), ISPICKVAL(StageName, &apos;Execute (Start Delivery)&apos;), Product_Only_Offer_RS__c &gt; 0, OR(NF_LoA_Bypass__c=2,NF_LoA_Bypass__c=3)  )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
D-1687: Unlocking will be based on Sales Phase</description>
    ...
    <rules>
        ...
        <formula>AND( $Profile.Name &lt;&gt;  $Label.Data_Loader_Profile_Name ,OR( ISCHANGED( Project_description_major_reason__c ), ISCHANGED( Risk_Action_plan__c ), ISCHANGED( Risk_Deadline__c ), ISCHANGED( Risk_Owner__c ), ISCHANGED( Risk_Support_required__c ), ISCHANGED( Risk_Rating__c ), ISCHANGED( Risk_type__c ) ))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND( $Profile.Name &lt;&gt; $Label.Data_Loader_Profile_Name ,OR( ISCHANGED(  Upside_Project_description_major_reason__c  ), ISCHANGED(  Upside_Action_plan__c  ), ISCHANGED(  Upside_Deadline__c  ), ISCHANGED(  Upside_Owner__c  ), ISCHANGED(  Upside_Support_required__c  ), ISCHANGED(  Upside_Rating__c ) ))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
PreSales : SFTicket : 00005192</description>
        <formula>AND($Profile.Name &lt;&gt; $Label.Data_Loader_Profile_Name, ISBLANK( Opportunity_ID__c ),  OR($RecordType.DeveloperName = &apos;Direct_Record_Type&apos;, $RecordType.DeveloperName = &apos;Indirect_Record_Type&apos;)   )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
