...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <description>Email notification to be sent out if Partner Status is Customer or Partner Terminated_SFDX_GIT_1207</description>
    ...
    <outboundMessages>
        ...
        <description>Test_SFDX_GIT_1207</description>
