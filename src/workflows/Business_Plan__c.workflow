...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <description>Business Plan Submission Email Notification_test</description>
    ...
    <alerts>
        ...
        <description>Business Plan Successful Cloning  Notification If not Populate PRM_test</description>
        <protected>false</protected>
        <recipients>
