...
TEXT(Partner_Type_Update__c)= &apos;Yes&apos;, 
TEXT(Request_Status__c)= &apos;Remove&apos;, NOT(TEXT(Partner_Contact__r.User_Create_Status__c) = &apos;Inactive&apos;), NOT( OR( $User.ProfileId =&apos;00e41000000wIbR&apos;, $User.ProfileId =&apos;00e41000000wIbT&apos;)), NOT(ISCHANGED(Partner_Type_Update__c)))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
