...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <description>Email notification to be sent out if the Partner Status is Customer Terminated or Partner Terminated tester</description>
    ...
    <alerts>
        ...
        <ccEmails>gss.partnersupport@nokia.com</ccEmails>
        <description>Notification to Icare tester123</description>
        <protected>false</protected>
        <senderAddress>nokia_global_partner_communications@nokia.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
