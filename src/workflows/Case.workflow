...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <description>PRM Related</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
    ...
    <fieldUpdates>
        ...
        <formula>CH_CustomerDescription__c + &apos; &apos; + CH_IssueDescription__c + &apos; &apos; + CH_InitialDiagnosis__c + &apos; &apos; + CH_TemporarySolution__c + &apos; &apos; + CH_Product_Name__c + &apos; &apos; +  CH_Product_Release_Name__c</formula>
    ...
    <fieldUpdates>
        ...
        <formula>CH_SystemRestored__c</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            ...
            <operation>equals</operation>
            <value>Nokia Incident with Restoration,Nokia Information Request,Nokia Standard Case</value>
        </criteriaItems>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>OR(AND(CH_RecordTypeCheck__c , ISPICKVAL( Status , &apos;Closed&apos;),CH_LegacyCaseNumber__c=null), AND(CH_RecordTypeCheck__c , ISPICKVAL( Status , &apos;Closed&apos;),$Label.CH_Enable_Completion_of_Legacy_Cases=&apos;Yes&apos;,CH_LegacyCaseNumber__c!=null))</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <formula>AND(RecordType.DeveloperName = &quot;CH_NokiaIncidentWithRestoration&quot;, ISPICKVAL( Severity__c , &apos;Critical&apos;), ISPICKVAL( CH_Outage__c , &apos;No&apos;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>PRM Related</fullName>
        <actions>
            <name>PRM_Related</name>
            <type>Alert</type>
        </actions>
        <actions>
            <name>PRM_Related</name>
        ...
        <description>Case management for PRM project.</description>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Case.Primary_Interest_CP__c</field>
            <operation>includes</operation>
            <value>Cloud &amp; data centers (Nuage)</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
