...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>Bypass_Condition_Update</fullName>
        <field>By_Pass_Count__c</field>
        <formula>If( AND(ISPICKVAL(No_Support_Offer_Condition__c,&apos;Yes&apos;),OR(Blanket_Approval_Condition__c=&apos;Blanket Approval for T&amp;C&apos;,Blanket_Approval_Condition__c=&apos;Blanket Approval for Price and T&amp;C&apos;)),3, 
IF(OR(Blanket_Approval_Condition__c=&apos;Blanket Approval for T&amp;C&apos;,Blanket_Approval_Condition__c=&apos;Blanket Approval for Price and T&amp;C&apos;),2, 
IF(ISPICKVAL(No_Support_Offer_Condition__c,&apos;Yes&apos;),1,0) 
) 
)</formula>
        <name>Bypass Condition Update</name>
    ...
    <fieldUpdates>
        <fullName>NF_FU_Update_LOA_Level</fullName>
        <field>LOA_Level__c</field>
        <formula>Text(LoA_Approval_Level__c)</formula>
        <name>NF_FU_Update_LOA_Level</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
...
//TSALEM</description>
    ...
    <rules>
        <fullName>NF_WF_Update _LOA_Level _Opportunity</fullName>
        <actions>
            <name>NF_FU_Update_LOA_Level</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>AND(  ActiveOffer__c = true , $User.ProfileId != $Label.Data_Loader_Profile_Id )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Update the Bypass Count</fullName>
        <actions>
            <name>Bypass_Condition_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Update the bypass count depends on the blanket approval or No Offer Support Condition</description>
        <formula>AND(  ActiveOffer__c=True, OR(  ISNEW(),  ISCHANGED(Blanket_Approval_Condition__c), ISCHANGED( No_Support_Offer_Condition__c)    ),  $Profile.Name&lt;&gt; $Label.Data_Loader_Profile_Name   )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
